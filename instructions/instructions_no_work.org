...
* Two-Day Experiment
  ...
  - The experiment today is a simplified version of the experiment on Day 2.
  - You will be paid just your show-up fee of $7 today.
  - At the end of Day 2, you will receive:
     + a $12 show-up fee
     + all earnings from today
     + all earnings from Day 2
* The Big Idea
** Payment
...
* First Day
  - For today, you will not select jobs to work on.  Instead, a computer will automatically work on those with the nearest deadlines. This may not be the best strategy.
  - On Day 2, you will have to perform all roles.
  - Additionally, today earnings will be only moderately sensitive to your performance.
  - Day 2 earnings will be very sensitive to your performance, with good decisions being highly rewarded and poor play earning little to no money.
* Review
